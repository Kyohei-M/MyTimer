...
namespace MyTimer
{
    ...
    class MainPageViewModel : BindableBase
    {
        ...
        public string SpeechText { get => _speechText; set => SetProperty(ref _speechText, value); }

        // タイマー時間経過後に案内音声を使うか？（使わない場合、Audio 再生）
        private bool _useSpeechText = true;
        public bool UseSpeechText { get => _useSpeechText; set => SetProperty(ref _useSpeechText, value); }
